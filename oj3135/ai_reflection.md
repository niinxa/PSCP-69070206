...
| OJ submission ID, if submitted | 636891 |
| OJ status | Pass |
...
```text
พอดีฉันติดtestcaseบางอัน เลยให้ AI ช่วยดูโค้ดของฉันและช่วยหาว่าในโค้ดมีจุดไหนที่อาจผิด และ ช่วยดูโค้ดส่วนนี้ gift = (x * k) % n
```
...
```text
AI ช่วยบอกฉันว่า ต้องเช็คกรณีที่ขโมยเป็น 1 ด้วย มันจะได้หยุดทำงานและพิมพ์1 ออกมา และ ตรงส่วนโค้ดนี้ gift = (x * k) % n  ต้องเพิ่ม + 1 เพราะ ถ้าไม่มี gift จะได้ 0 แต่คนเริ่มที่ 1
```
...
```text
ฉันกลับไปเพิ่มเงื่อนไข เช็คขโมย ==  1 ให้ print(1) และ return ค่ากลับ ก่อนเข้า whlie และ เพิ่ม + 1 ใส่ gift = (x * k) % n เพื่อให้เลื่อนตำแหน่ง จากต่ำสุดเป็น 0 ก็จะขยับมาเป็น 1
```
...
```text
ฉันได้เรียนรู้ การใช้ return เพื่อ return ค่า ใส่ฟังก์ชัน 
ฉันได้เรียนรู้การที่ ใช้ modulus เพื่อเอาเศษ โดยเราสามารถเพิ่ม + 1 ใส่เศษที่หาได้แล้ว ได้
ฉันเรียนรู้การเช็คบางจุดที่โจทย์ไม่ได้บอกมา แต่เราต้องสังเกตเอง
```
