...
```text
โจทย์ให้หาจำนวนคนที่ได้พิจารณาของขวัญ จากการส่งต่อของวัญไปเรื่อยๆเป็นวงกลม

Input: 
จำนวนคนทั้งหมด จำนวนการส่งของขวัญให้คนถัดไป คนที่เป็นขโมย

Output:
จำนวนคนที่ได้พิจารณาของขวัญ

Constraints:
ใช้ .split ในการแยกค่า และใช้ % หาคนที่ได้ของชวัญ
```
...
```text
step1: ฉันใช้ map(int,input().split()) เพื่อแยกค่าแต่ละตัวในบรรทัดใส่ตัวแปร
step2: สร้างตัวแปร x = 1 count = 0 gift = 0
step3: ฉันใช้ while loop เพื่อวนการส่งของขวัญไปเรื่อยๆ
step4: ฉันคำนวนหา gift =  (x * k) % n + 1
step5: count += 1 (จำนวนคนที่ได้พิจารณาของงขวัญ)
step6: เช็คว่า gift = ขโมยไหม
step7: ถ้าใช่ count += 1 และ break ออกloop
step8: เช็คว่า gift = 1 ไหม
step9: ถ้าใช่ ให้ break ออกloop
step10: x += 1
step11: พิพ์ count
```
...
```text
วิธีสุดท้ายของฉันคล้ายกับแผนแรก แต่เพิ่ม if ก่อน whlie เพื่อเช็คกรณีที่ขโมยเป็นคนที่1 จะได้ตอบ พิจารณา1คน
```
...
```text
เช็คว่า ถ้าวนกลับมาเป็นคนที่ 1 จะหยุดทำงานไหม
```
...
```text
เช็คว่า ถ้าวนกลับมาเป็นคนที่เป็นขโมย จะหยุดทำงานไหมและบวกคนพิจารณาชองขวัญไหม
```
...
```text
เช็คว่า ถ้าขโมยเป็นคนที่1 จะหยุดทำงานแลพิมพ์0 ไหม
```
