...
```text
โจทย์ให้รับตำแหน่งต้นทางและปลายทาง กับ น้ำหนักของพัสดุ และเอาไปเปรียบเทียบกับในตาราง เพื่อหาราคาทั้งหมดที่ต้องจ่าย
Input:
บรรทัดแรก รับค่าต้นทาง ปลายทาง
บรรทัดสอง รับน้ำหนักพัสดุ

Output:
ราคาค่าส่งพัสดุ ทศนิยม2ตำแหน่ง
ถ้าเส้นทางที่ระบุไม่อยู่ในตารางให้แสดงข้อความว่า Error

Constraints:
ใช้ .split() ในการแยกข้อความที่อยู่ในบรรทัดเดียวกัน
```
...
```text
Step1: รับค่าใส่ตัวแปร
Step2: เช็คค่าตัวแปรต้นทางและปลายทางตามตาราง โดยใช้ if/else
Step3:ถ้าตรงตามในตาราง ให้พิมพ์ ราคาตามตารางที่ผ่านการคำนวณ
Step4:ราคา * ระยะทาง + ค่าธรรมเนียม
Step5:ถ้าไม่ตรง พิมพ์ Error
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก ฉันใช้ if elif else เช็คเงื่อนไขตามตาราง และคำนวณค่าตามเลขในตาราง ใช้ f-string :.2f เพื่อตอบราคาแบบทศนิยม2ตำแหน่ง ถ้าไม่ตรงตามเงื่อนไข ตอม Error 
```
