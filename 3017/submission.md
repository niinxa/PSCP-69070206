...
```text
โจทย์ให้คิดจำนวนเงินที่ลูกค้าต้องจ่ายหลังจากรวมค่าบริการและ VAT 

input():
ค่าอาหารและเครื่องดื่ม ที่เป็นจำนวนเต็ม

output():
จำนวนเงินที่คิดรวมค่าบริการและ VAT 7% เรียบร้อยแล้ว (เป็นจำนวนจริงทศนิยม 2 หลัก)

constaints:
ค่าบริการต้องอยู่ระหว่าง50 - 1000
```
...
```text
step 1 :
รับค่าinput ที่เป็นจำนวนเต็ม
stap 2:
คิดคำนวณค่าบริการก่อน
step3:
ตรวจสอบว่าค่าบริการน้อยกว่า50ไหม ถ้าน้อยกว่าให้เเท่ากับ 50
step4:
ตรวจสอบว่าค่าบริการมากกว่า1000ไหม ถ้ามากกว่าให้เเท่ากับ 1000
step5:
คำนวณค่าvat
step6:
นำค่าทั้งหมดที่ได้มารวมกัน
step7:
ตอบในรูปทศนิยมม2ตำแหน่ง
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก เพราะหาค่าบริการก่อน และนำไปหาvatต่อ ตามที่โจทย์ต้องการ และนำค่าที่หาทั้งหมดมารวมกัน
```
...
```text
เป็นค่าปกติ อยู่ระหว่าง50 - 1000
```
...
```text
เพราะมีเงื่อนไขที่ต้องเช็คว่าถ้าเลขต่ำกว่า50 ต้องเท่า50
```
...
```text
เพราะมีเงื่อนไขที่ต้องเช็คว่าถ้าเลขมากกว่า1000 ต้องเท่า1000
```
