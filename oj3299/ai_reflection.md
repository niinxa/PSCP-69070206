...
| Item | Answer |
|---|---|
| OJ problem number/title | OJ3299 - [LEARNING LOGS] แปลงดอกไม้ |
| OJ submission ID, if submitted | 663093 |
| OJ status | Pass |
...
```text
ฉันถาม AI เกี่ยวกับสูตรการหาว่าช่องสุดท้ายอยู่แทบไหน เพราะฉันคิดแล้วมันออกมาตรง แต่ผิด
```
...
```text
AI บอกว่าที่ฉันคิดสูตรออกมามันผิดจริงๆ เลยแนะนำให้เอา จำนวนแถบที่สะสมมา - 1 และค่อยเอาไปบวกกับจำนวนแถบที่ต้องการนับ -1 สุดท้ายก็เอาไปหารลงตัวกับจำนวนแถบที่ต้องการนับ
```
...
```text
ฉันปรับวิธีการคิดหาแถบที่ตัวสุดอย่างอยู่ใหม่ จนผ่าน
```
...
```text
ฉันเรียนรู้แนวคิดการทำโจทย์คำนวณมากขึ้น
ฉันเรียนรู้การกลับไปอ่านโจทย์ตัวเองซ้ำ ว่าเจอสุดที่เขียนผิดไหม
รู้จักการลองผิดลองถูกมากขึ้น
```
