...
| OJ submission ID, if submitted | 625407 |
| OJ status | Pass |
...
```text
ฉัน ให้ AI ช่วยดูวิธีการหาอิฐก้อนใหญ่และหาเศษเหลือ จากโค้ดที่ฉันเขียนก่อนหน้า ว่าคำนวณถูกไหม ถ้าไม่ถูก ช่วยใบ้วิธีหาที่ถูกต้อง
```
...
```text
AI ช่วยให้ฉันสังเกตว่า ฉันคำวณจำนวนที่ต้องใช้อิฐก้อนใหญ่ผิด ควรเอาขนาดสะพาน // ขนาดอิฐก้อนใหญ่ก่อน ถ้าหารแล้วจำนวนที่ใช้ > จำนวนที่มี ให้จำนวนที่ใช้ = จำนวนที่มีอยู่ ถึงค่อยเอาไปหาเศษ  ตรงหาเศษก็ใช้ - แทน %
```
...
```text
ฉันแก้วิธีการหาอิฐก้อนใหญ่ที่ต้องใช้ใหม่  และ การคำนวณหาเศษ
```
...
```text
ฉันเข้าใน logic ในข้อนี้มากขึ้น และ ควรอ่านโจทย์ให้เข้าใจ เพราะ มีบางเงื่อนไขที่ต้องเช็คแต่ฉันดันมองข้าม
```
