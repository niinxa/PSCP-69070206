...
```text
โจทย์ต้งการให้คำนวนหาว่าต้องใช้อิฐเล็กน้อยสุดกี่ก้อน โดยต้องต่อหินก้อนใหญ่ไปให้ครบตามขนาดที่ไม่เกินความยาวอิฐ ให้อิฐก้อนเล็กยาว 9นิ้ว อิฐก้อนใหญ่จะมีความยาว 5 นิ้ว
input:
1.จำนวนอิฐก้อนเล็ก
2.จำนวนอิฐก้อนใหญ่
3.ขนาดขนาดของสะพานที่ต้องการ
output:
จำนวนอิฐก้อนเล็กที่ต้องใช้
ถ้าไม่สามารถสร้างได้ ตอบ -1
constraint:
เราต้องรู้ว่าต้องใช้ก้อนใหญ่กี่ก้อนก่อน ถึงค่อยไปหาว่าพื้นที่ที่เหลือต้องใช้หินก้อนเล็กกี่ก้อน
```
...
```text
step1: รับค่าinputเข้ามา
step2: เอาหินก้อนใหญ่ * 5
step3: หาเศษเหลือที่ต้องใช้อิฐก้อนเล็กจาก ขนาดสะพาน % ก้อนหินใหญ่
step4: ตรวจเศษ > 0 หรือไม่
step5: ถ้าใช่ ตอบ ขนาดก้อนเล็ก
step6: ถ้าไม่ใช่ ตอบ -1
...
```text
วิธีสุดท้ายที่ฉันใช้คล้ายกับแผนแรก แต่ฉันตรวจหาก่อนว่าหินก้อนใหญ่ที่สามารถใช้ได้คือเท่าไหร่ก่อน โดย เอา อิฐก้อนใหญ่ // 5 และถ้าอิฐที่ใช้มากกว่าอิฐทังหมด ก็ให้เท่ากับที่มีอยู่ จากนั้นไปหาเศษที่ต้องใช้หินก้อนเล็ก โดยเอา ขนาดสะพาน - หินก้อนใหญ่ที่ใช้ * 5 สุดท้ายเอาค่าที่ได้ไปเช็คว่าสามารถเอาอิฐก้อนเล็กได้โปะได้ไหม
```
...
```text
เพราะจะเช็คว่า ถ้าิอิฐใหญ่ที่ต้องใช้จริงๆ > จำนวนอิฐใหญ่ที่มี จะเอาถึงแค่ที่มีมาคำนวณ
```
...
```text
ถ้าเศษที่ต้องเอาอิฐเล็กมาโปะ < จำนวนอิฐเล็ก จะต้องได้ -1
```
...
```text
ถ้ามีจำนวนอิฐก้อนเล็ก > เศษที่ต้องโปะ จะเอาแค่จำนวนอิฐก้อนเล็กที่มี
```
