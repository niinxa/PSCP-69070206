...
```text
สร้างโปรแกรมตรวจล็อตเตอร่ โดยรางวัลจะต่างกันไปตาม ตัวอักษร กับ เลขสลาก ที่ตรวจ

Input:
ผลการออกรางวัลสลากกินแบ่ง
ตัวอักษร เว้นวรรค ตัวเลขฉลาก ที่ต้องการตรวจ

Output:
เงินรางวัลที่ได้รับ ถ้าไม่ตรงเงื่อนไขเลย ตอบ 0 บาท

Constraints:
ควรใช้ string slicing เพื่อเอาไปตรวจเงื่อนไขที่ได้รางวัล
```
...
```text
step 1: รับผลการออกรางวัล ใส่ตัวแปร a
step 2: รับเลขล็อตเตอรี่ที่ซื้อ ใส่ตัวแปร b
step 3: ใช้ if ตรวจว่า a == b
step 4: พิมพ์ 1000000
step 5: ใช้ elif ตรวจ เลขทุกตัวของ a == เลขทุกตัวของ b
step 6: พิมพ์ 100000
step 7: ใช้ elif ตรวจ เลข3ตัวท้ายของและอักษรตัวแรก ของ a == เลข3ตัวท้ายและอักษรตัวแรก ของ b
step 8: พิมพ์ 2000
step 9: ใช้ elif ตรวจ เลข2ตัวท้ายของและอักษรตัวแรก ของ a == เลข2ตัวท้ายและอักษรตัวแรก ของ b
step 10: พิมพ์ 1000
step 11: ใช้ elif ตรวจเลข 3 ตัวท้าย ของ a == ตรวจเลข 3 ตัวท้าย ของ b
step 12: พิมพ์ 200
step 13: ใช้ elif ตรวจเลข 2 ตัวท้าย ของ a == ตรวจเลข 2 ตัวท้าย ของ b
step 14: พิมพ์ 100
step 15: ใช้ elif ตรวจอักษรตัวแรกของ a == ตรวจอักษรตัวแรกของ b
step 16: พิมพ์ 20
step 17: ใช้ else เพื่อ พิมพ์ 0 ถ้าไม่เข้าเงื่อนไขข้างบนเลย
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก ฉันใช้ string slicing เพื่อเช็คตำแหน่งของฉลากตามเงื่อนไขไปเรื่อยๆ และมีการจัดลำดับของif/else  เพื่อให้การตรวจถูกต้อง เช่น เช็คสามหลัก ก่อน เช็คสองหลัก
```
...
```text
ถ้าไม่เข้าเงื่อนไขไหนเลย พิมพ์ 0
```
...
```text
เพื่อเช็คว่าควรได้ 2000 เพราะ ต้องเข้าเงื่อนไขเลขท้าย3ตัวตรงกันก่อน
```
...
```text
เช็คว่าถ้าตรงกันทุกตำแหน่ง จะออกoutput ตามเงื่อนไขไหม
```
