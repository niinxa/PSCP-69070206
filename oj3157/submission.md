...
```text
โจทย์ให้คำนวนคะแนนรวม จากคะแนนที่รับเข้ามาตามคำสั่ง

Input:
จำนวนคำสั่งที่จะรับเข้ามา
คำสั่ง + / -

Output:
จำนวนคะแนนรวมทั้งหมดหลังผ่านการคำนวน

Constraints:
ใช้ for loop วนตามจำนวนคำสั่ง เพื่อรับคำสั่งมาคำนวณ
```
...
```text
step1: รับจำนวนคำสั่ง สร้างตัวแปรคะแนน = 0
step2: ใช้ for loop วนตามจำนวนคำสั่ง เพื่อรับ คำสั่งมา
step3: เช็คว่าคำสั่งใช่ + ไหม
step4: ถ้าใช่ คะแนน += 10
step5: ถ้าไม่ใช่ เช็คต่อว่าใช่ - ไหม
step6: ถ้าใช่ คะแนน  -= 5
step7: แสดงผลคะแนนทั้งหมด
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก ฉันใช้ for loop วน เพื่อรับคำสั่งมา และใช้ if/else เช็คว่าคำสั่งนั้นเป็นอะไร และคำนวนตามนั้น
```
