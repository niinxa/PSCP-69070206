...
```text
โจทย์ให้คำนวณเวลาที่่น้ำหมึกจะมายังพิกัดบ้านแต่ละหลัง ตามคำร้องที่รับเข้ามา

Input:
- พื้นที่ที่น้ำหมึกแผ่ขยายต่อ1วิ คำร้องของผู้คน
- บรรทัดที่ n พิกัดบ้าน (x,y)

Output:
- บรรทัดที่ n เวลาที่น้ำหมึกจะมาถึงพิกัดบ้าน

Constraints:
ถ้าคำนวนเวลาออกมาแล้วไม่เป็นจำนวนเต็ม จะปัดขึ้นให้เป็นจำนวนเต็มหมด
```
...
```text
step1:รับค่า น้ำหมึกและคำร้อง แยกใส่ในสองตัวแปรด้วยmap
step2:ใช้ for loop วนตามคำร้อง เพื่อรับค่าพิกัดบ้านของคำร้องนั้น
step3:หาระยะห่างระหว่างจุดหมึกหยดกับพิกัดบ้าน เอาพิกัด ** 2 บวกกันและsqrt
step4:หาพื้นที่ เอาค่าpi * (ระยะห่าง **2)
step5:เอาพื้นที่ / เวลาที่หมึกขยายต่อ1วิ
step6;ใช้ math.celi เพื่อปัดทศนิยมขึ้น
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก คือใช้ for loop ในการวนคำร้อง เพื่อหาพิกัดบ้านแต่ละคน จากนั้นนำมาคำนวน คือเอาพิกัด ** 2 บวกกัน และนำไปsqrt จะได้ระยะห่างจากบ้านถึงจุดหมึกหยด เอาระยะห่าง ** 2 คูณ ค่าpi เพื่อได้ค่าพื้นที่ออกมา จากนั้นนำพื้นที่ไปหารค่าหมึกหยดต่อวิ จะได้ระยะเวลาออกมา และค่อยปัดเศษขึ้นด้วย math.celi
```
...
```text
เพื่อนช่วยบอกวิธีหาระยะห่างจุดกำเนิดหมึกกับบ้าน และวิธีหาพื้นที่ทั้งหมดที่หมึกไหล
```

คุณยังทำอะไรด้วยตนเอง

```text
ฉันยังเขียนทุกอย่างในโค้ดด้วยตัวเอง เช่น การรับinput print  และเขียนsubmissionด้วยตัวเอง
```
