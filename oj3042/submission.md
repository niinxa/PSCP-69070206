...
```text
โจทย์ให้รับจำนวนมา แล้วหาว่าตั้งแต่เลขนั้นถึง0 มีเลขที่หาร10 ลงตัว มีเลขอะไรบ้าง
Input:
รับจำนวนเต็มบวกจำนวน 1จำนวน

Output:
ตัวเลขที่หาร10ลงตัว มีช่องว่างคั่น

Constraints:
output ต้องไล่จากจำนวนเต็มบวก - 0
```
...
```text
step1: สร้างnum รับค่าinput
step2: สร้างlist ไว้เก็บเลขที่หาร10ลงตัว
step3: ใช้loopเช็คเลขตั้งแต่เลขinput ถึง 0 (num,-1,-1)
step4: สร้างเงื่อนไขในloop ว่า 1 % 10 ไหม
step5: ถ้าใช่ ให้เก็บเลขนั้นเข้าlist
step6: ใช้.join() แปลงlist เป็นstring
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก คือเช็คว่าตั้งแต่เลขinputถึง0 มีเลขอะไรที่หาร10ลงตัวบ้าง ถ้ามี ให้เก็บใส่list และprint ออกมาเป็นข้อความ จากการใช้.join()
```
...
```text
เช็คว่าเจอเลขที่หาร10ลงตัวจริงไหม
```
...
```text
เช็คว่าถ้าไม่เจอเลขที่หาร10ลงตัวเลย จะได้0
```
...
```text
เช็คว่าถ้าเจอเลขติดลบ จะไม่print อะไรออกมาเลย
```
