...
```text
โจทย์ให้หาจำนวน ในช่วงa -  b ว่ามีเลขที่หารd และเหลือเเศษr กี่จำนวน
...
output:
จำนวนนับที่หารและเหลือเศษ กี่จำนวน

Constraints:
ต้องหาเลขที่หารได้ จากนั้นค่อยนับจำนวนว่ามีกี่ตัว
```
...
```text
step1: รับค่าinputทั้งหมด
step2: สร้างlistไว้เก็บตัวเลข
step3: ใช้ for i in range(จำนวนแรก,จำนวน2+1)
step4: สร้างเงื่อนไข ถ้า i % int(d) == int(r)
step5: ถ้าจริง ให้เพิ่มค่าi ใส่list
step6: print(len(num_list))
```
...
```text
ใช้วิธีแรก ใช้for loop เลขตัวแรกถึงตัวสอง และเช็คว่าแต่ละตัวในนั้น modulo แล้วได้เศษตามค่าที่ระบุไว้ไหม ถ้าใช่เพิ่มเข้าlist และเช็คว่าในlistมีทั้งหมดกี่ตัว
```
...
```text
ตรวจว่าถ้าเลขAและB เป็นตัวเดียวกัน จะรันผ่านไหม
```
