...
```text
โจทย์ให้รับค่าสีมา แล้วนำมาผสมกัน (โดยการบวกและหาร2)
input:
รับค่าสีที่1 3ค่า
รับค่าสีที่2 3ค่า
output:
สีทั้งสามค่าที่ผ่านการผสม
 constraints:
ตรงการนำไปหาร ใช้ // เพื่อให้ค่าออกมาเป็นจำนวนเต็มตามที่โจทย์ต้องการ
```
...
```text
step1: รับค่าสีเป็นจำนวนเต็ม3สีแยกใส่ตัวแปร โดยใช้split()
step2: สร้างตัวแปรใหม่มาเก็บค่าสีที่ผ่านการผสมแล้ว
step3: พิมพ์สีที่ผ่านการผสมในบรรทัดเดียวกัน
```
...
```text
วิธีสุดท้ายที่ฉันใช้จริงเหมือนกับแผนแรก ฉันใช้map เพื่อใช้spilแยกinput จากstringเป็นint เก็บใส่ตัวแปร และเอาค่ามาคำนวณกันโดยบวกกันก่อนแล้วยค่อย // เพื่อหารให้ออกมาเป็นint
```
...
```text
เลขเป็นเลขที่หารไม่ลงตัว มีเศษ
```
