...
```text
โจทย์ให้คำนวนหาจำนวนครั้ง ที่กบต้องกระโดด จนไปถึงเป้าหมาย

Input:
โปรแกรมรับระยะกระโดดแต่ละครั้ง
โปรแกรมรับระยะเป้าหมาย

Output:
จำนวนครั้งที่กบต้องกระโดด จนถึงระยะเป้าหมาย ถ้าไม่ถึงแสดงเลข -1

Constraints:
การกระโดดครั้งต่อไประยะจะลดลงทีละ2 จากระยะกระโดดทุกๆครั้ง
1 ≤ ระยะกระโดด ≤ 1000
1 ≤ ระยะเป้าหมาย ≤ 100000
```
...
```text
step 1: รับinput ในบรรทัดเดียวกัน แยกใส่ตัวแปร
step 2: สร้างตัวแปรเก็บระยะที่ต้องกระโดด
step 3: สร้างตัวแปรเก็บจำนวนครั้งที่ต้องกระโดด
step 4: ใช้ while True
step 5: สร้าง if เช็ค ว่าระยะกระโดด >= เป้าหมายไหม
step 6: ถ้าใช่ ให้ใช้ break ออกloop
step 7: สร้าง if เช็คว่า ระยะกระโดดแต่ละครั้ง <= 0 ไหม
step 8: ถ้าใช่ ให้ใช้ break ออกloop
step 9: ระยะกระโดด += ระยะโดดทุกครั้ง
step 10: จำนวนกระโดด += 1
step 11: ระยะกระโดดแต่ละครั้ง -= 2
step 12: หลังจากออกloop มาแล้ว ใช้ if เช็คว่า ว่าระยะกระโดด >= เป้าหมายไหม
step 13: ถ้าใช่ print จำนวนกระโดด
step 14: ถ้าไม่ใช่ print -1
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก คือฉันใช้ whlie True เพื่อวนloop และคำนวน ระยะและจำนวนที่กระโดด จากนั้นเมื่อถึงเป้าหมาย ใช้ break เพื่อออกจากloop สุดท้าย ใช้ if/else เพื่อเช็คและprint จำนวนการกระโดดของกบตามเงื่อนไข
```
...
```text
เพื่อเช็คว่าโค้ดนี้คำนวนจำนวนการกระโดดถูกไหม
```
...
```text
เพื่อเช็คว่าถ้า ระยะกระโดดลดลงเรื่อยๆจนถึง0 แล้วยังกระโดดไม่ถึงเป้าหมาย ต้องprint -1
```
...
```text
เพื่อเช็คว่าถ้าระยะกระโดดเริ่มต้น >= เป้าหมายแล้ว ก็ไม่ต้องloop และprintจำนวนออกมาเลย
```
