...
```text
โจทย์ให้นับจำนวนสระที่มีอยู่ในข้อความที่รับเข้ามา เป็นได้ทั้งพิมพ์เล็กและพิมพ์ใหญ่
Input:
ข้อความที่ต้องการนับ

Output:
สระที่มีในข้อความและจำนวนที่มี

Constraints:
output มีแค่สระที่เจอ และ จะตรวจโดยไม่สนว่าจะเป็นพิมพ์เล็กหรือใหญ่
```
...
```text
step1: รับinputเข้ามา และแปลงให้เป็นตัวพิมพ์เล็กก่อนให้หมด
step2: สร้างตัวแปรมาเก็บจำนวนสระ
step3: หาจำนวนสระโดยการใช้ .count 
step4: สร้างเงื่อนไข ตรวจว่าถ้าจำนวนสระนั้นมากกว่า0ไหม
step5: ถ้าใช่ ให้printจำนวนของสระนั้น
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก ฉันใช้.lower เพื่อทำให้ข้อความที่รับเข้ามาเป็นพิมพ์เล็กให้หมด แล้วค่อยเอาไปตรวจเงื่อนไขอื่นๆต่อ ใช้ .count นับจำนวนสระว่ามีกี่ตัว
```
...
```text
เพื่อตรวจว่าแปลงเป็นพิมพ์เล็กไหม
```
...
```text
เพื่อตรวจว่าจะนับทั้งพิมพ์เล็กพิมพ์ใหญ่ไหม
```
...
```text
เพื่อตรวจว่านับสระครบทุกตัวไหม a e i o u
```
