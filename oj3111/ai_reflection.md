...
| OJ submission ID, if submitted | 631033 |
| OJ status | Pass |
...
```text
ฉันถาม AI ว่าจะเลื่อน2ทศนิยมแรกยังไง และเลื่อนเอา2ทศนิยมลงกลับแบบเดิมยังไง
```
...
```text
AI ทำให้ฉันเข้าใจว่าการ เลื่อนเอาทศนิยมขึ้น ต้อง * ขึ้นไป เช่น เอา2ตำแหน่งขึ้น ก็ * 100 (อยากเอากี่ตำแหน่งขึ้น ขึ้นอยู่กับเลข0) ส่วนตอนเลื่อนเอาทศนิยมลง ก็ทำแบบเดียวกัน แค่เปลี่ยนจาก * เป็น /
```
...
```text
ฉันเอาการเลื่อนทศนิยมไปใช้ เพื่อเลื่อนเอา2ตำแหน่งแรกขึ้น จากนั้นค่อยใช้math.ceil ปัดเศษทศนิยมที่เหลือขึ้น จากนั้นเลื่อนทศนิยมลงมา2ตำแหน่งแบบเดิม
```
...
```text
ฉันได้เรียนรู้การเลื่อนทศนิยมลง และ เลื่อนทศนิยมขึ้น สามารถเอาความรู้นี้ไปใช้กับโจทย์อื่นๆที่ต้องคำนวณแนวนี้ในอนาคตได้
```
