...
```text
โจทย์ให้ฉันรับค่าอุณภูมิมา เป็นหน่วย1 และให้แปลงอุณภูมิเป็นหน่วยที่2

Input:
1.รับค่าอุณภูมิ
2.รับหน่วยอุณภูมิแรก
3.รับหน่วยอุณภูมิสอง(ที่ต้องการแปลง)

Output:
โปรแกรมแสดงอุณภูมิ ที่ถูกแปลงจากหน่วยที่1 เป็นหน่วยที่2 (ทศนิยม2ตำแหน่ง)

Constraints:
ตามสูตรคำนวนอุณภูมิ  แต่ละหน่วยใช้องศาเซลเซียสในการคำนวนทั้งคู่ ควรหน่วย1เป็นเซลเซียสก่อนคิดหน่วย2
```
...
step2: แปลงหน่วยอื่นๆ เป็น เซลเซียส
step3: ตรวจว่าหน่วยแรกเป็นหน่วยอะไร
step4: ตรวจว่าหน่วยที่2เป็นอะไร
step5: แปลงอุณภูมิตามหน่วยที่ตรวจเจอ
```
...
```text
ทำคล้ายๆวิธีแรกที่คิด แต่กำหนดค่าเซลเซียส = 0 จากนั้นให้ตรวจหน่วยแรกก่อนและค่อยแปลงหน่วยนั้นเป็นเซลเซียส
เก็บใส่ตัวแปรเซลเซียส จากนั้นค่อยเอาไปคิดหาหน่วยที่2 ตามเงื่อนไขที่เช็ค
```
...
```text
เช็คว่าสามารถแปลงหน่วยได้ไหม แต่อันนี้ยังมีตัวแปรC  ทำให้การแปลงไม่ซับซ้อนมาก
```
...
```text
เช็คว่าสามารถแปลงหน่วยได้ไหม แต่อันนี้มีความซับซ้อนกว่าtestcase1 เพราะต้องคำนวน2ต่อ
```
...
```text
เช้คว่าใส่ C ทั้งสองรอบ จะออกมาเป็นอุณภูมิเดิมไหม
```
