...
| OJ submission ID, if submitted | 563702 |
| OJ status | Pass |
...
```text
ฉันได้เขียนโค้ดเสร็จแล้ว แต่เหมือนจะคิดซับซ้อนเกินไป เลยใช้ if/else เกิน pep-8 ฉันเลยถาม AI ว่าสามารถย่อโค้ดของฉันให้สั้นลงและเข้าใจง่ายมากขึ้นไหม
```
...
```text
สังเกตุว่ามีวิธีเเขียนที่ง่ายและเข้าใจง่ายกว่า ให้การเขียนข้อนี้ คือการสร้างตัวแปรเก็บค่าเซลเซียส จากการคำนวนของหน่วยนั้นๆ ตามเงื่อนไข
```
...
```text
แก้โค้ดให้เข้าใจง่ายขึ้น แก้ให้เก็บเซลเซียสใส่ตัวแปร เพื่อลดบรรทัดในการเขียนลง
```
...
```text
การสร้างตัวแปรไว้เก็บค่าสำคัญมาก ถึงจะดูเป็นเรื่องเล็กๆ แต่มันสามารถช่วยในการเขียนโค้ดหลายอย่าง เช่น ทำให้ลดบรรทัดในการเขียนและอ่านง่ายมากยิ่งขึ้น
```
