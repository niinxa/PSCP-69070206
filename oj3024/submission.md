...
```text
โจทย์อยากหาความต่างของเลขมากที่สุดกับน้อยที่สุด ว่ามีโอกาสเกิดคำว่าSurprisingไหม

Input:
รับค่าคะแนนรวมทั้ง3คน
รับค่าคะแนนคนที่ได้สูงที่สุด

Output:
"Surprising" หรือ "Not surprising"

Constraints:
โจทย์บอกว่า มีโอกาส แปลว่า สามารถสมมุติคะแนนให้ได้ผลลัพธ์ตามโจทย์ได้
```
...
```text
step1: รับค่าinput
step2: สร้างlistมาเก็บคะแนนของ2คนที่เหลือ ที่เป็นไปได้
step3: หาคะแนนสองคนที่เหลือจาก คะแนนมากสุด - คะแนน3คน
step4: หาเลข2ตัวที่เป็นไปได้ จากการใช้loop
step5: ถ้าเลข2ตัวนั้นบวกกันได้เท่ากับคะแนนสองตัวที่เหลือ ให้บันทึกใส่list
step6: สร้างตัวแปรเก็บผลต่างคะแนนมากสุด - น้อยสุด(ใช้minครอบlist)
step7: ตรงว่ามากว่า2ไหม
step8: ถ้าใช่ พิมพ์Surprising
step9: ถ้าไม่ใช่ พิมพ์Not Surprising
```
...
```text
ฉันใช้วิธีอื่น คือการสมมุติให้คะแนนมากสุดมี2คน ทำให้ได้ค่าน้อยสุดที่เป็นไปได้ จากนั้นนำค่านั้นไปตรวจเงื่อนไขว่า Surprising ไหม
```
...
```text
เพื่อตรวจว่า เลขน้อยสุดห่างจากเลขมากสุด มากกว่า2ไหม ถ้าใช่พิมพ์ "Surprising"
```
...
```text
เพื่อตรวจว่า เลขน้อยสุดห่างจากเลขมากสุด น้อยกว่า2ไหม ถ้าใช่พิมพ์ "Not Surprising"
```
...
```text
เพื่อตรวจว่า เลขน้อยสุดห่างจากเลขมากสุด(เป็นเลขติดลบ) น้อยกว่า2ไหม ถ้าใช่พิมพ์ "Not Surprising"
```
...
```text
เพื่อนบอกมาว่า พี่TA แนะนำให้สมมุติคะแนนมากสุดเป็น2คนเลย แล้วจะได้คนที่น้อยที่สุดเลย โดยไม่ต้องทำวิธียากๆ
```

คุณยังทำอะไรด้วยตนเอง

```text
นอกจากจุดคำนวณหาเลขน้อยสุด จุดอื่นๆก็ทำเองหมดเลย
```
